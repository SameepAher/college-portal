    ...
    <div>
      <Router>
        <Switch>
          ...
          <Route exact path="/faculty/update-profile" component={FacultyUpdateProfile} />
          <Route exact path='/faculty/attendence' component={AttendenceFaculty} />
          <Route exact path="/faculty/update-password" component={FacultyUpdatePassword} />
          <Route exact path="/faculty/upload-marks" component={FacultyUploadMarks} />
          
          <Route exact path='/admin' component={AdminHome} />
          <Route exact path="/admin/add-faculty" component={AdminAddFaculty} />
          <Route exact path="/admin/add-student" component={AdminAddStudent} />
          <Route exact path="/admin/add-subject" component={AdminAddSubject} />
          <Route exact path="/admin/add-admin" component={AdminAddAdmin} />
          <Route exact path="/admin/all-faculties" component={AdminGetAllFaculty} />
          <Route exact path="/admin/all-students" component={AdminGetAllStudent} />
          <Route exact path="/admin/all-subjects" component={AdminGetAllSubject} />
          ...
          <Route exact path="/forgot-password/:user" component={ForgotPassword} />
