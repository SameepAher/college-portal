...
const FacultyStudentLoginPage = () => {
  ...
  const [facultyRegistrationNumber, setFacultyRegistrationNumber] =
    useState("");
              ...
              <div>
                ...
                <form noValidate onSubmit={facultyFormHandler}>
                  <div className="form-group">
                    ...
                    <input
                      onChange={(e) =>
                        setFacultyRegistrationNumber(e.target.value)
                      }
                      type="text"
                ...
                <p className="text-center mt-2 ">
                  <Link className="text-center" to="/forgot-password/faculty">
                    Forgot Password
                  </Link>
                </p>
              </div>
          ...
          <div className="row m-5">
            ...
            >
              <div>
                ...
                <p className="text-center mt-2">
                  <Link className="text-center" to="/forgot-password/student">
                    Forgot Password
                  </Link>
                </p>
              </div>
