                    ...
                    {!helper ? <>
                        <form noValidate onSubmit={sendOTPHandler}>
                            <div className="form-group">
                                ...
                                })} id="userEmailId" placeholder="Provide registered email address" aria-describedby="emailHelp" />
                                <small id="emailHelp" className="form-text text-muted">OTP will be valid only for 5 minutes</small>
                                {errors.email && (
